...
*
* @param {Number} max - maximum integer to be returned
* @returns {Integer} 
*/
function randint(max) {
...
//**********************
// Comment out for informal testing
// module.exports = lcg;

// Informal testing code follows:

function outputRands(n) {
	var i;
	var seed = 1;
	var myRand = lcg(seed);
	for(i = 1; i <= n; i++) {
